...
namespace API.Migrations
{
    ...
    [Migration("20211214100932_Testing654654")]
    partial class Testing654654
    {
            ...
            modelBuilder.Entity("API.Models.Output", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Tag = "0301A",
                            Time = new TimeSpan(401717986745)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Person = "Ella Ahlström",
                            Tag = "0301A",
                            Time = new TimeSpan(401717986809)
                        },
                        new
                        {
                            ID = 3,
                            ...
                            Tag = "0302A",
                            Time = new TimeSpan(401717986817)
                        });
                });
